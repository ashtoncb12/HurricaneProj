...
for i in range(len(names)):
  info_names.update({names[i - 1]: {"Name": names[i - 1], "Month": months[i - 1], "Year": years[i - 1], "Max Sustained Wind": max_sustained_winds[i - 1], "Areas Affected": areas_affected[i - 1], "Damage": damages[i - 1], "Deaths": deaths[i - 1]}})

info_years = {}
for i in range(len(names)):
  info_years.update({years[i - 1]: {"Name": names[i - 1], "Month": months[i - 1], "Year": years[i - 1], "Max Sustained Wind": max_sustained_winds[i - 1], "Areas Affected": areas_affected[i - 1], "Damage": damages[i - 1], "Deaths": deaths[i - 1]}})
